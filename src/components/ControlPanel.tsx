import { FileText, Download, Upload, Copy, Trash2, Code, FileDown, Image, ClipboardPaste, FileUp } from "lucide-react";
...
const themes = [
  ...
  { value: "elegant", label: "Elegant Serif", icon: "📜" },
  { value: "ocean", label: "Ocean Blue", icon: "🌊" },
  { value: "forest", label: "Forest Green", icon: "🌲" },
  { value: "sunset", label: "Sunset Orange", icon: "🌅" },
  { value: "royal", label: "Royal Purple", icon: "👑" },
  { value: "rose", label: "Rose Pink", icon: "🌸" },
  ...
  return (
    <div className="bg-card rounded-lg border border-border p-4 space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <Button variant="outline" onClick={onInsertImage} className="gap-2">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" onClick={onPaste} className="gap-2">
